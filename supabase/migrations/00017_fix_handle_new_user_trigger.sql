...
BEGIN
    ...
    IF final_role = 'admin'::public.user_role THEN
        final_permissions := ARRAY['dashboard', 'students', 'classes', 'fees', 'attendance', 'exams', 'notices', 'gallery', 'school_home', 'queries', 'admin_management', 'teachers'];
    ...
    INSERT INTO public.profiles (id, username, role, student_id, teacher_id, permissions, is_master)
    VALUES (
        NEW.id,
